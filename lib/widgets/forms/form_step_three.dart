...
class _FormStepThreeState extends State<FormStepThree> {
  ...
  List<dynamic> _crearCampos(double screenWidth) {
    ...
    return [
      InputFieldConfig(
        icon: Icons.email,
        controller: widget.registerUserController.controllers[ControllerKeys.patente]!,
      ...
      InputFieldConfig(
        icon: Icons.key,
        controller: widget.registerUserController.controllers[ControllerKeys.licencia]!,
